...
class TRANSFORMERAttenLin(nn.Module):

    def __init__(self, freeze_bert, tokenizer, model, exp_args):
        super(TRANSFORMERAttenLin, self).__init__()
    ...
    def forward(self, input_ids=None, attention_mask=None, labels=None, input_pos=None,  mode = None, args = None):
        ...
        packed_input, perm_idx, seq_lengths = get_packed_padded_output(attention_applied, attention_mask, self.tokenizer)
